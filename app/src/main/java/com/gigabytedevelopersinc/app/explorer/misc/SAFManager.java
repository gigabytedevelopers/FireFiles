...
import static com.gigabytedevelopersinc.app.explorer.misc.IntentUtils.ACTION_OPEN_DOCUMENT_TREE;
import static com.gigabytedevelopersinc.app.explorer.provider.ExternalStorageProvider.ROOT_ID_SECONDARY;
import static com.gigabytedevelopersinc.app.explorer.provider.UsbStorageProvider.ROOT_ID_USB;
...
public class SAFManager {
    ...
    public static String getRootUri(Uri uri) {
        if (isTreeUri(uri)) {
            return com.gigabytedevelopersinc.app.explorer.model.DocumentsContract.getTreeDocumentId(uri);
        }
        return com.gigabytedevelopersinc.app.explorer.model.DocumentsContract.getDocumentId(uri);
    }

    private static Uri buildDocumentUriMaybeUsingTree(Uri uri, String docId) {
        return com.gigabytedevelopersinc.app.explorer.model.DocumentsContract.buildDocumentUriMaybeUsingTree(uri, docId);
    }

    private static boolean isTreeUri(Uri uri) {
        return com.gigabytedevelopersinc.app.explorer.model.DocumentsContract.isTreeUri(uri);
    }
